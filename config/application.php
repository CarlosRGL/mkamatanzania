...
// $webroot_host = ( env( 'WP_SSL' ) == 'on' ? 'https://' : 'http://' ) . $_SERVER['HTTP_HOST'];
...
// Config::define( 'WP_REDIS_TIMEOUT', 3 );
...
/**
 * DB settings multisite
 */
// Config::define( 'WP_ALLOW_MULTISITE', true );
// Config::define( 'MULTISITE', true );
// Config::define( 'SUBDOMAIN_INSTALL', true );
// Config::define( 'DOMAIN_CURRENT_SITE', env( 'WP_NETWORK_HOME' ) );
