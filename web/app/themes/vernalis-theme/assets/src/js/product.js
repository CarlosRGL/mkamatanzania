...
const rafraichirPrix = () => {
  ...
  if (tarif_avant_premiere == '' || tarif_avant_premiere == 0 
      || nombre_de_places_en_tarif_avant_premiere == '' || nombre_de_places_en_tarif_avant_premiere == 0) {
    $('.avant_premiere').hide();
  }
  if (tarif_reduction_si_2_personnes == '' || tarif_reduction_si_2_personnes == 0 
      || nombre_de_places_en_reduction_si_2_personnes == '' || nombre_de_places_en_reduction_si_2_personnes == 0) {
    $('.reduction_si_2_personnes').hide();
  }
  if (tarif_reduction_si_4_personnes == '' || tarif_reduction_si_4_personnes == 0 
      || nombre_de_places_en_reduction_si_4_personnes == '' || nombre_de_places_en_reduction_si_4_personnes == 0) {
    $('.reduction_si_4_personnes').hide();
  }
  if (tarif_reduction_1 == '' || tarif_reduction_1 == 0 
      || nombre_de_places_en_reduction_1 == '' || nombre_de_places_en_reduction_1 == 0) {
    $('.reduction_1').hide();
  }
  if (tarif_reduction_2 == '' || tarif_reduction_2 == 0 
      || nombre_de_places_en_reduction_2 == '' || nombre_de_places_en_reduction_2 == 0) {
    $('.reduction_2').hide();
  }
  ...
  total = total_plein_tarif + total_2_pour_le_prix_dune + total_avant_premiere + total_reduction_si_2_personnes + 
          total_reduction_si_4_personnes + total_reduction_1 + total_reduction_2;
